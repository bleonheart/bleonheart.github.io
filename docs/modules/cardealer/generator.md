# Vehicle Item Generator

Create vehicle items for the car dealer system that players can purchase, customize, and store.

---

<h3 style="margin-bottom: 5px; font-weight: 700;">Overview</h3>
<div style="margin-left: 20px; margin-bottom: 20px;">
  <p>Use this tool to generate the Lua structure for your custom vehicle item. Once generated, the code should be placed in a new file within the items directory.</p>
  <p><strong>Recommended Placement:</strong></p>
  <code style="display: block; padding: 12px; background: rgba(0, 0, 0, 0.05); border-left: 4px solid #46a9ff; margin-top: 10px; font-family: 'JetBrains Mono', monospace;">modules/cardealer/items/[item_id].lua</code>
</div>
