...
- Updated client library with improved daily rewards functionality
- Code cleanup and documentation optimization
- Enhanced daily rewards system and user interface
- Improved objective tracking and reward distribution

### Version 1.3

- Standardized all author and contact information
- MODULE.author = "Lilia Team" → "Samael"
